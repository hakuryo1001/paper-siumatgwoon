...
Axiom 4: If $a*b=c$ for some $a,b,c\in S$, then $a|c$ and $b|c$.
\end{axiom}
...
The above 4 axioms are the core axioms of a Siumatgwoon. To specify certain more restrictive structures, we will now introduce two more axioms. These two axioms seem to capture certain behaviours of the Sinoglyphs, and are therefore interesting.
